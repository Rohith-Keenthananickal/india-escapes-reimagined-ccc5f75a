                      ...
                      {cartItemsForMap.map((item, index) => (
                        ...
                        >
                          <div className="relative">
                            ...
                            <div className="absolute -top-1 -left-1 w-5 h-5 rounded-full bg-[#9C27B0] text-white text-xs flex items-center justify-center font-bold shadow-sm">
                              {index + 1}
                            </div>
                          </div>
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute top-2 right-2">
                              <Button
                                ...
                                className="bg-white/90 hover:bg-white text-red-600 hover:text-red-700 rounded-full w-7 h-7 p-0"
                              >
                                <X className="w-3 h-3" />
                              </Button>
                            </div>
                            <div className="absolute bottom-2 left-2">
                              <div className="bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 flex items-center">
                                <Hotel className="w-3 h-3 text-blue-600 mr-1" />
