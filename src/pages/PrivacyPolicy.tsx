...
const PrivacyPolicy = () => {
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Booking details (dates, homestay, services opted)",
            "Location data (optional — for better recommendations)",
            "Payment information (processed securely through trusted gateways; we do not store card data)",
            "Device information (IP, app usage analytics)"
          ]
        },
        {
          ...
          items: [
            ...
            "To provide personalised stay & experience recommendations",
            "For 24/7 customer support",
            "To ensure safety, verification, and compliance of stays",
        ...
        },
        {
          ...
          items: [
            "Verified Hosts for confirmed bookings",
            "Area Tourism Promoters (ATPs) for safety & verification",
        ...
        },
        {
          ...
          items: [
            "Booking history is stored for legal & service purposes",
        ...
        },
        {
          ...
          items: [
            ...
            "Manage notifications & location permissions"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Avoid misuse, fraudulent bookings, or multi-account abuse"
          ]
        },
        {
          ...
          items: [
            ...
            "Host has the right to deny stay if guest violates safety rules",
            "Guests must show valid ID during check-in"
          ]
        },
        {
          subtitle: "Cancellation & Refunds",
          items: [
            "Refund eligibility will follow each host's cancellation policy",
      ...
      sections: [
        {
          ...
          items: [
            "Full/partial refund depends on host's cancellation rules",
            "Processing time: 5–7 business days",
            "Refunds go back to original payment method",
            "No refunds for no-show or last-minute cancellations unless specified by host"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            "All homestays verified by ATPs",
            "Hosts undergo ID and property verification",
            "Emergency support available 24/7",
            "Guests must follow safety instructions provided by hosts"
          ]
        }
      ]
    }
      ...
      sections: [
        {
          ...
          items: [
            "ATP profile details (name, phone, address)",
            "Host onboarding data & documents",
            "Inspection reports & photos",
            "Device/location data for verification routes"
          ]
        },
        {
          subtitle: "How We Use It",
          items: [
            "To verify homestay listings",
            "To track ATP performance & commissions",
            "To maintain platform quality standards"
          ]
        },
        {
          subtitle: "Sharing of Information",
          items: [
            "With hosts for onboarding progress",
            "With Trip Haven Co admin team",
            "Never shared with outsiders for commercial use"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            "Verify homestays as per checklist",
            "Upload legitimate documents and photos",
            "Maintain professional behaviour with hosts & guests",
        ...
        },
        {
          ...
          items: [
            "Commission available only for confirmed bookings",
            "Fraudulent onboarding will lead to account suspension"
          ]
        },
        {
          subtitle: "Prohibited Activities",
          items: [
            "Fake host listings",
            "Taking money personally from hosts or guests",
            "Manipulating reports or booking data"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Payments released monthly upon verification",
            "Commission disputes resolved within 7–14 days"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            "ATPs must follow code of conduct",
            "No harassment or misuse of access",
            "Report unsafe homestays immediately"
          ]
        }
      ]
    }
      ...
      sections: [
        {
          ...
          items: [
            "Host details, photos, property documents",
            "Bank account details for payouts",
            "Guest chat & booking history",
            "Service & experience listing details"
          ]
        },
        {
          subtitle: "Why We Collect It",
          items: [
            "To verify homestay authenticity",
            "To process guest bookings",
            "To deliver secure payouts",
            "To maintain platform trust and safety"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Maintain cleanliness, hygiene, and safety",
        ...
        },
        {
          ...
          items: [
            "Payouts released after guest check-out",
            "Platform service charges apply",
            "Hosts must ensure accurate pricing"
          ]
        },
        {
          subtitle: "Prohibited Conduct",
          items: [
            "Accepting offline payments outside the platform",
            "Cancelling confirmed bookings without reason",
            "Uploading misleading or fake photos",
            "Harassing guests or misbehaving"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            "Penalties may apply",
            "Calendar blocking may occur for repeated cancellations"
          ]
        },
        {
          subtitle: "For Guests",
          items: [
            "Host-specific cancellation policy applies"
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            "All homestays must meet basic safety standards",
            "Fire safety, first-aid kit, and clean drinking water required",
            "Host must follow local laws & tourism regulations"
          ]
        }
      ]
    }
  ...
  const renderPolicyCard = (policy: typeof guestPolicies[0]) => (
    <Card key={policy.title} className="mb-6 border-border/50 bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="pt-6 space-y-6">
        {policy.sections.map((section, idx) => (
          <div key={idx} className="space-y-3">
            ...
            {section.content && (
              <p className="text-muted-foreground text-sm pl-4">{section.content}</p>
            )}
            <ul className="space-y-2 pl-4">
              {section.items.map((item, itemIdx) => (
                <li key={itemIdx} className="text-muted-foreground text-sm flex items-start gap-2">
            ...
            {section.note && (
              <p className="text-sm font-medium text-primary pl-4">{section.note}</p>
            )}
          </div>
        ))}
      </CardContent>
