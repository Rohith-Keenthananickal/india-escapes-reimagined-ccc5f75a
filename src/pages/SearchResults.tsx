...
const PriceMarker = ({ property, onClick, isSelected }: { 
  ...
  return (
    ...
    >
      ...
      >
                       <div className={`
                 border-2 rounded-2xl shadow-lg px-3 py-2 min-w-[80px]
                 ${isSelected
...
const SearchResults = () => {
  ...
  const PropertyOverlay = ({ property }: { property: Property }) => {
    ...
    return (
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-96 max-w-[90vw] rounded-3xl">
      ...
      <GoogleMapsLoader>
        ...
        <div className="px-10 py-6">
          <div className={`grid grid-cols-1 lg:${
            ...
            >
              <Card className="h-[calc(100vh-200px)] sticky rounded-2xl relative overflow-hidden shadow-lg">
